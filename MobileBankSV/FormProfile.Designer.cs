namespace MobileBankSV
{
    partial class FormProfile
    {
        ...
        private void InitializeComponent()
        {
			...
			this.buttonEnter.Location = new System.Drawing.Point(329, 124);
			this.buttonEnter.Name = "buttonEnter";
			this.buttonEnter.Size = new System.Drawing.Size(243, 40);
			this.buttonEnter.TabIndex = 54;
			this.buttonEnter.Text = "Редактировать  пароль";
			...
			this.button2.Text = "Редактировать  э.почту";
