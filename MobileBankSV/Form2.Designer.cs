namespace MobileBankSV
{
    partial class FormRegister
    {
        ...
        private void InitializeComponent()
        {
			...
			this.label8.Text = "Введите адрес эл почты";
			// 
			// buttonEnter
			// 
			...
			this.buttonEnter.Location = new System.Drawing.Point(11, 497);
			this.buttonEnter.Name = "buttonEnter";
			this.buttonEnter.Size = new System.Drawing.Size(255, 47);
			...
			this.pictureBox4.Location = new System.Drawing.Point(237, 12);
			...
			this.label15.Text = "Введите номер телефона";
			// 
			// checkBox1
			// 
			...
			this.checkBox1.Location = new System.Drawing.Point(130, 400);
			...
			this.label16.Text = "Введите пароль повторно";
			// 
			// textBox7
			// 
